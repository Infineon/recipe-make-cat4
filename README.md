# 4390X GNU make Build System

## Overview

This repo provides the build recipe make files and scripts for building and programming 4390X applications. Builds can be run either through a command-line interface (CLI) or through a supported IDE such as Eclipse or VS Code.
...
## More information
* [Recipe-make-cat4 Release Notes](./RELEASE.md)
