...
################################################################################
# \copyright
# (c) 2017-2025, Cypress Semiconductor Corporation (an Infineon company) or
...
#
# ElfFile   - Path to ELF file to load
# init4390  - run initialisation for the 4390
###############################################################################
proc sflash_init { ElfFile init4390 } {
...
proc program_sflash { filename foffset dataSize destaddr cmd } {
    global ElfFile MemoryStart data_size_loc data_loc dest_address_loc command_loc result_loc entry_address RESULT  entry_address_loc
...
# init4390     - run initialisation for the 4390
###############################################################################
proc sflash_write_file { filename destAddress ElfFile erasechip init4390 } {
...
# init4390     - run initialisation for the 4390
###############################################################################
proc sflash_read_file { filename srcAddress ElfFile length init4390 } {
...
proc sflash_erase { ElfFile init4390 } {
