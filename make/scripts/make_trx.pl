...
#
# \brief
# This script adds an TRX (External Program Memory) header to a program
...
#alignment of 0 or 1 means no alignment
    ...
    {
#misaligned if previous segments left off on unaligned boundary
        $misalignment_amount = $total_segment_size % $needed_alignment;
    }
